...
mod test {
    ...
    use splitchain_escrow::splitchainEscrow;
    ...
    fn test_contract_initialization() {
        let env = Env::default();
        splitchainEscrow::init(env.clone());
    ...
    fn test_create_split_basic() {
        ...
        // Create split
        env.mock_all_auths();
        let split_id = splitchainEscrow::create_split(
            env.clone(),
            creator.clone(),
            Symbol::short("dinner"),
            1000i128,
    ...
    fn test_create_split_three_way() {
        ...
        let split = splitchainEscrow::get_split(env.clone(), split_id);
    ...
    fn test_deposit_share() {
        ...
        splitchainEscrow::deposit_share(
            env.clone(),
            participant1.clone(),
            split_id,
            1000i128,
        ...
        let share = splitchainEscrow::get_participant_share(
            env.clone(),
            split_id,
            participant1.clone(),
        );
    ...
    fn test_settle_split() {
        ...
        splitchainEscrow::deposit_share(env.clone(), participant1.clone(), split_id, 1000i128);
        splitchainEscrow::deposit_share(env.clone(), participant2.clone(), split_id, 1000i128);

        // Settle the split
        splitchainEscrow::settle_split(env.clone(), split_id);

        // Verify split is settled
        assert!(
            splitchainEscrow::is_split_settled(env.clone(), split_id),
            "Split is marked as settled"
        );

        // Get settlement details
        let settlement = splitchainEscrow::get_settlement(env.clone(), split_id);
    ...
    fn test_get_user_splits() {
        ...
        // Create first split
        let _split_id_1 = splitchainEscrow::create_split(
            env.clone(),
            creator.clone(),
            Symbol::short("lunch"),
            1000i128,
        ...
        // Create second split
        let _split_id_2 = splitchainEscrow::create_split(
            env.clone(),
            creator.clone(),
            Symbol::short("dinner"),
            2000i128,
        ...
        // Get user's splits
        let user_splits = splitchainEscrow::get_user_splits(env.clone(), creator.clone());
    ...
    fn test_multiple_splits_sequential_ids() {
        ...
        let split_id_1 = splitchainEscrow::create_split(
            env.clone(),
            creator.clone(),
            Symbol::short("split1"),
            1000i128,
        ...
        let split_id_2 = splitchainEscrow::create_split(
            env.clone(),
            creator.clone(),
            Symbol::short("split2"),
            2000i128,
    ...
    fn test_partial_deposit() {
        ...
        splitchainEscrow::deposit_share(env.clone(), participant1.clone(), split_id, 500i128);
